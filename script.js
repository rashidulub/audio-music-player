...
let musics = [
    {
    trackName: "Pochish Bochhor",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/download (2).jpeg",
    audioSource:"/music/25bochor.mp3"
},
    {
    trackName: "Ai J Duniya",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/download (1).jpeg",
    audioSource:"/music/ai j duniya.mp3"
},
    {
    trackName: "Ato Vebona tmi",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/download (3).jpeg",
    audioSource:"/music/Eto Bhebona এত ভবন (Teaser) [TubeRipper.com].mp3"
}
,
    {
    trackName: "Tmro ki pore mone",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/download.jpeg",
    audioSource:"/music/tmro ki mone pore.mp3"
}
,
    {
    trackName: "Ai khola Chul ",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/images.6jpeg.jpeg",
    audioSource:"/music/ai khola chul.mp3"
}
,
    {
    trackName: "Akasher dike takiye tmi ",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/images5.jpeg",
    audioSource:"/music/akasher dike takiye tmi.mp3"
}
,
    {
    trackName: "Bondi char dike",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/maxresdefault7.jpg",
    audioSource:"/music/bondi cardike.mp3"
}
,
    {
    trackName: "Prionmoi",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/oar4.jpg",
    audioSource:"/music/priyonmoi.mp3"
}
,
    {
    trackName: "Bus Shohokari",
    artist: "Kazi Zohad Yazdani",
    album: "Pochish Bochhor",
    coverImage:"/image/download (1).jpeg",
    audioSource:"/music/bus sohokari.mp3"
}
];
